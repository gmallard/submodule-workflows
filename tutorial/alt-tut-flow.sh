...
#
# The tutorial seems to be missing a complete initialization of the
# submodules for this superproject.  THe following is also required in order
# to produce correct results.  An alternative 'fix' is to change the 
# 'git submodule update' at the end of this script to 'git submodule update --init'.
#
git submodule init
#
# Continue per the tutorial instructions.
#
ls -a
#
...
# visible.  See comments above about changes made to actually make this
# work.
cat a/a.txt
#
set +x
